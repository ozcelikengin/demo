...
# locating dataset
DATADIR_TEST = "/Users/ozcelikengin/Desktop/all_signatures_squared_128"
DATADIR = "/Users/ozcelikengin/Desktop/all_signatures_squared_imitation_128"
...
def create_training_data():
    for category in CATEGORIES:
        ...
        for img_test in os.listdir(path_test):
            try:
                img_test_array = cv2.imread(os.path.join(path_test,img_test), cv2.IMREAD_GRAYSCALE)
