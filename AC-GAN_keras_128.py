...
os.makedirs("images_128", exist_ok=True)
...
if __name__ == '__main__':
    ...
    (x_train, y_train), (x_test, y_test) = aslrDataset_128.create_training_data()
    ...
    for epoch in range(1, epochs + 1):
        ...
        if (epoch % 10) == 0:
            ...
            Image.fromarray(img).save(
                'images_128/plot_epoch_{0:03d}_generated.png'.format(epoch))
